...
// FilterFunc returns the filter function that returns true for the controllers that should be started.
// If migrated is true, only the controllers that should be started when holding the migration lock will
//  go through.
