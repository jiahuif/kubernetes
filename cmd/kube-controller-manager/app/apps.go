...
func startDaemonSetController(ctx ControllerContext) (controller.Interface, error) {
...
func startStatefulSetController(ctx ControllerContext) (controller.Interface, error) {
...
func startReplicaSetController(ctx ControllerContext) (controller.Interface, error) {
...
func startDeploymentController(ctx ControllerContext) (controller.Interface, error) {
