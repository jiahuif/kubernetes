...
func StartControllers(ctx ControllerContext, startSATokenController InitFunc, controllers map[string]InitFunc, unsecuredMux *mux.PathRecorderMux) error {
	...
	for controllerName, initFn := range controllers {
		...
		if debugHandler := ctrl.DebuggingHandler(); debugHandler != nil && unsecuredMux != nil {
...
func (c serviceAccountTokenControllerStarter) startServiceAccountTokenController(ctx ControllerContext) (cmcontroller.Controller, error) {
