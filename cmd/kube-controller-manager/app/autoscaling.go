...
func startHPAController(ctx ControllerContext) (controller.Interface, error) {
...
func startHPAControllerWithRESTClient(ctx ControllerContext) (controller.Interface, error) {
...
func startHPAControllerWithLegacyClient(ctx ControllerContext) (controller.Interface, error) {
	hpaClient := ctx.ClientBuilder.ClientOrDie("horizontal-pod-autoscaler")
...
func startHPAControllerWithMetricsClient(ctx ControllerContext, metricsClient metrics.MetricsClient) (controller.Interface, error) {
	hpaClient := ctx.ClientBuilder.ClientOrDie("horizontal-pod-autoscaler")
